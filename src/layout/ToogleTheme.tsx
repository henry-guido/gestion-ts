  ...
  return (
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        <SunIcon className={`h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all ${isChangingTheme ? '' : 'dark:-rotate-90 dark:scale-0'}`} />
            <MoonIcon className={`absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all ${isChangingTheme ? '' : 'dark:rotate-0 dark:scale-100'}`} />
